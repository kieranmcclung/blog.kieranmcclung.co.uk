---
date: "2021-04-27T09:30:29.497Z"
title: Three pillars of web design; designing more consistent websites
excerpt: When approaching a new web design I often stick to my three pillars of
  design; colour use, text hierarchy and white space, to ensure a consistent
  outcome. Here's how it's done.
featuredImage: /images/adam-miller-dbaz0xhckpy-unsplash-crop.jpg
seoDescription: Designing a new website can be overwhelming but using these
  three rules can help ease the process and results in a consistent design.
showDonationLink: 1
---
...
![Example showing a hierarchy of text styles from largest to smallest](/images/type.png)
...
![Example design showing headings in purple, two styles of button with orange accents and a body of text with orange links](/images/colour-use.png)
...
_Featured image by [Adam Miller](https://unsplash.com/@adamthehooligan?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/s/photos/space?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)_
